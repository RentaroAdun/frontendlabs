<template>
  <div class="container table-responsive">
    <table id="cart" class="table table-hover table-sm" v-if="cartItemList.length">
      <thead>
        <tr>
    ...
    <div v-else class="d-flex justify-content-center"><h1>Your shopping cart is empty</h1></div>
  </div>
</template>
